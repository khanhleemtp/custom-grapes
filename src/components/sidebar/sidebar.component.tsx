...
const Sidebar: React.FC<Props> = ({ children }) => {
  ...
  return (
    <div
      className={clsx(
        "flex transform transition-all delay-150 duration-200",
    ...
    >
      <div className="relative min-h-screen max-h-screen">
        ...
        >
          {isShowing ? (
            <ChevronRightIcon className="text-gray-400 w-full h-full" />
          ) : (
            <ChevronLeftIcon className="text-gray-400 w-full h-full" />
          )}
        </div>
        ...
        <div className="w-72 min-h-screen max-h-screen overflow-hidden ring-1 ring-gray-400 relative">
          <div className="divide-y-2">
            {/* 1 - Logo & link */}
            <div className="text-blue-500 font-semibold text-xl text-opacity-95 flex items-center space-x-2 p-2">
              <div>
            ...
            <div className="w-full h-full">
              <Tab.Group>
                ...
                <div className="absolute left-0 h-full w-full flex flex-col bg-white shadow-lg">
                  <Tab.Panels className="overflow-auto h-full w-full scrollbar-thin scrollbar-thumb-gray-200 hover:scrollbar-thumb-gray-300 scrollbar-track-white scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
